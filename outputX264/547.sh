...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --rc-lookahead 60 --no-mbtree --no-8x8dct  --no-cabac --no-weightb --no-mixed-refs  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='547,true,true,true,true,false,false,true,true,true,60,9'
