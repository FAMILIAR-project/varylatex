...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --no-8x8dct --rc-lookahead 60 --no-deblock   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='467,true,true,true,false,true,false,false,false,false,60,5'
