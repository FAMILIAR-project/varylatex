...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --no-8x8dct --rc-lookahead 60 --no-deblock --no-mbtree  --no-cabac --no-mixed-refs  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='797,true,true,true,true,true,false,true,true,false,60,9'
