...
(gtime -f "USERTIME %U\nSYSTEMTIME %S\nELAPSEDTIME %e\nMEMORYTIME %K" x264 --no-asm --ref 1 --rc-lookahead 40  --no-weightb  -o sintel$numb.flv $trailerlocation) 2> $logfilename
# size of the video
...
csvLine='179,true,false,true,false,false,false,false,false,true,40,1'
