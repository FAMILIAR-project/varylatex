...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --no-fast-pskip --no-mbtree --rc-lookahead 60  --no-cabac --no-weightb  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='327,true,false,true,true,false,true,true,false,true,60,5'
