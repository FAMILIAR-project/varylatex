...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --ref 9 --no-fast-pskip --rc-lookahead 60 --no-8x8dct --no-mbtree --no-deblock  --no-cabac --no-weightb --no-mixed-refs  -o /srv/local/macher/bench3/tempvids/sintel$numb.264 $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='487,true,true,false,true,true,true,true,true,true,60,9'
