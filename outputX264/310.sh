...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --no-8x8dct --no-mbtree --rc-lookahead 40  --no-mixed-refs  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='310,true,true,true,false,false,false,true,true,false,40,5'
