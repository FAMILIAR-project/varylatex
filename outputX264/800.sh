...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --no-fast-pskip --no-8x8dct --rc-lookahead 60   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='800,true,true,true,false,false,true,false,false,false,60,5'
