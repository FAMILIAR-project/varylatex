...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --no-fast-pskip --rc-lookahead 60 --no-mbtree  --no-mixed-refs  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='838,true,false,true,false,false,true,true,true,false,60,5'
