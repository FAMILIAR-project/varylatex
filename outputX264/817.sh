...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --no-mbtree --no-8x8dct --rc-lookahead 20   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='817,true,true,true,false,false,false,true,false,false,20,5'
