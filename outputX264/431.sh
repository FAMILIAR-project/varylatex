...
(gtime -f "USERTIME %U\nSYSTEMTIME %S\nELAPSEDTIME %e\nMEMORYTIME %K" x264 --no-asm --ref 5 --rc-lookahead 60 --no-mbtree --no-8x8dct  --no-mixed-refs  -o sintel$numb.flv $trailerlocation) 2> $logfilename
# size of the video
...
csvLine='431,true,true,true,false,false,false,true,true,false,60,5'
