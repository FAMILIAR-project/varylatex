...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --ref 9 --no-deblock --no-8x8dct --rc-lookahead 60  --no-cabac  -o /srv/local/macher/bench3/tempvids/sintel$numb.264 $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='233,true,true,false,true,true,false,false,false,false,60,9'
