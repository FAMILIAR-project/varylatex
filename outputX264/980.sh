...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --ref 9 --no-mbtree --no-8x8dct --no-deblock --rc-lookahead 20  --no-cabac --no-weightb --no-mixed-refs  -o /srv/local/macher/bench3/tempvids/sintel$numb.264 $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='980,true,true,false,true,true,false,true,true,true,20,9'
