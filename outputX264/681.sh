...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --no-fast-pskip --rc-lookahead 60 --no-8x8dct --no-mbtree --no-deblock  --no-cabac  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='681,true,true,true,true,true,true,true,false,false,60,9'
