...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --rc-lookahead 60 --no-deblock --no-8x8dct  --no-weightb  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='293,true,true,true,false,true,false,false,false,true,60,5'
