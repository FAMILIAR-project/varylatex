...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --ref 9 --no-8x8dct --no-mbtree --no-deblock --rc-lookahead 20  --no-weightb  -o /srv/local/macher/bench3/tempvids/sintel$numb.264 $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='1092,true,true,false,false,true,false,true,false,true,20,9'
