...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --no-fast-pskip --rc-lookahead 60  --no-cabac  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='1004,true,false,true,true,false,true,false,false,false,60,1'
