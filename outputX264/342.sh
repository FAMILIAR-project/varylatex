...
(gtime -f "USERTIME %U\nSYSTEMTIME %S\nELAPSEDTIME %e\nMEMORYTIME %K" x264 --no-asm --ref 5 --no-fast-pskip --rc-lookahead 40   -o sintel$numb.flv $trailerlocation) 2> $logfilename
# size of the video
...
csvLine='342,true,false,true,false,false,true,false,false,false,40,5'
