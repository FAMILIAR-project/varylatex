...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --no-fast-pskip --no-deblock --rc-lookahead 40   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='52,true,false,true,false,true,true,false,false,false,40,1'
