...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --no-mbtree --no-deblock --rc-lookahead 40  --no-mixed-refs  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='615,true,false,true,false,true,false,true,true,false,40,1'
