...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --ref 9 --no-fast-pskip --no-8x8dct --no-deblock --no-mbtree --rc-lookahead 60  --no-cabac --no-mixed-refs  -o /srv/local/macher/bench3/tempvids/sintel$numb.264 $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='413,true,true,false,true,true,true,true,true,false,60,9'
