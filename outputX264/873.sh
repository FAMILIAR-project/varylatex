...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --ref 5 --no-fast-pskip --no-8x8dct --rc-lookahead 20   -o /srv/local/macher/bench3/tempvids/sintel$numb.264 $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='873,true,true,false,false,false,true,false,false,false,20,5'
