...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --no-fast-pskip --no-mbtree --no-deblock --rc-lookahead 20  --no-cabac --no-weightb  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='1137,true,false,true,true,true,true,true,false,true,20,9'
