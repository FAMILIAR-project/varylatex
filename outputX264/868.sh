...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --no-deblock --no-8x8dct --no-mbtree --rc-lookahead 20   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='868,true,true,true,false,true,false,true,false,false,20,5'
