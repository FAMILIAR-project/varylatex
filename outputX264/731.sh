...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --no-fast-pskip --rc-lookahead 60 --no-mbtree  --no-cabac  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='731,true,false,true,true,false,true,true,false,false,60,5'
