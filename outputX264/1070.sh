...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --no-fast-pskip --no-deblock --no-8x8dct --rc-lookahead 60   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='1070,true,true,true,false,true,true,false,false,false,60,9'
