...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --no-mbtree --no-8x8dct --no-deblock --rc-lookahead 40  --no-weightb --no-mixed-refs  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='882,true,true,true,false,true,false,true,true,true,40,9'
