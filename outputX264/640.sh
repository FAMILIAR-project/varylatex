...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --no-fast-pskip --rc-lookahead 60 --no-mbtree --no-8x8dct   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='640,true,true,true,false,false,true,true,false,false,60,1'
