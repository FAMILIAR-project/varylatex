...
(gtime -f "USERTIME %U\nSYSTEMTIME %S\nELAPSEDTIME %e\nMEMORYTIME %K" x264 --no-asm --ref 9 --no-fast-pskip --no-deblock --no-8x8dct --no-mbtree --rc-lookahead 40  --no-weightb  -o sintel$numb.flv $trailerlocation) 2> $logfilename
# size of the video
