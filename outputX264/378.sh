...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --rc-lookahead 60  --no-weightb --no-mixed-refs  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='378,true,false,true,false,false,false,false,true,true,60,5'
