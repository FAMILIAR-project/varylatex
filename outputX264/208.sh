...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --no-fast-pskip --no-8x8dct --rc-lookahead 20  --no-cabac --no-mixed-refs  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='208,true,true,true,true,false,true,false,true,false,20,9'
