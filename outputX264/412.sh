...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --rc-lookahead 60   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='412,true,false,true,false,false,false,false,false,false,60,9'
