...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --no-fast-pskip --rc-lookahead 60 --no-deblock  --no-weightb --no-mixed-refs  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='642,true,false,true,false,true,true,false,true,true,60,5'
