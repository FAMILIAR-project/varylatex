...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --ref 1 --no-fast-pskip --no-mbtree --no-8x8dct --rc-lookahead 20  --no-weightb --no-mixed-refs  -o /srv/local/macher/bench3/tempvids/sintel$numb.264 $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='155,true,true,false,false,false,true,true,true,true,20,1'
