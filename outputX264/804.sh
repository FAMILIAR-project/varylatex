...
(gtime -f "USERTIME %U\nSYSTEMTIME %S\nELAPSEDTIME %e\nMEMORYTIME %K" x264 --no-asm --ref 9 --no-8x8dct --rc-lookahead 60 --no-mbtree  --no-weightb  -o sintel$numb.flv $trailerlocation) 2> $logfilename
# size of the video
...
csvLine='804,true,true,true,false,false,false,true,false,true,60,9'
