...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --no-fast-pskip --no-deblock --no-8x8dct --rc-lookahead 60  --no-cabac --no-weightb --no-mixed-refs  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='1071,true,true,true,true,true,true,false,true,true,60,1'
