...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --ref 5 --no-deblock --no-8x8dct --no-mbtree --rc-lookahead 40  --no-weightb --no-mixed-refs  -o /srv/local/macher/bench3/tempvids/sintel$numb.264 $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='878,true,true,false,false,true,false,true,true,true,40,5'
