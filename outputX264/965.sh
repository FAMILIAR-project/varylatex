...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --ref 9 --rc-lookahead 60 --no-8x8dct --no-deblock --no-mbtree   -o /srv/local/macher/bench3/tempvids/sintel$numb.264 $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='965,true,true,false,false,true,false,true,false,false,60,9'
