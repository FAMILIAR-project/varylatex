...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --ref 9 --no-fast-pskip --no-mbtree --no-8x8dct --rc-lookahead 40  --no-cabac  -o /srv/local/macher/bench3/tempvids/sintel$numb.264 $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='108,true,true,false,true,false,true,true,false,false,40,9'
