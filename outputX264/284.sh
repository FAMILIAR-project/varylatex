...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --no-fast-pskip --no-deblock --rc-lookahead 20  --no-cabac --no-weightb  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='284,true,false,true,true,true,true,false,false,true,20,1'
