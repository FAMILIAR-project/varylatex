...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --rc-lookahead 60 --no-mbtree --no-deblock  --no-weightb  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='495,true,false,true,false,true,false,true,false,true,60,1'
