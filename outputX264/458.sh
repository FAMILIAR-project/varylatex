...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --no-fast-pskip --no-deblock --no-mbtree --no-8x8dct --rc-lookahead 20  --no-cabac  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='458,true,true,true,true,true,true,true,false,false,20,9'
