...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --no-deblock --rc-lookahead 60 --no-8x8dct   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='463,true,true,true,false,true,false,false,false,false,60,9'
