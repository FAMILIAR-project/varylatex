...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --rc-lookahead 60 --no-deblock --no-8x8dct  --no-mixed-refs  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='434,true,true,true,false,true,false,false,true,false,60,9'
