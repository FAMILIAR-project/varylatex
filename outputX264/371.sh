...
(gtime -f "USERTIME %U\nSYSTEMTIME %S\nELAPSEDTIME %e\nMEMORYTIME %K" x264 --no-asm --ref 5 --no-fast-pskip --no-deblock --rc-lookahead 20  --no-weightb  -o sintel$numb.flv $trailerlocation) 2> $logfilename
# size of the video
...
csvLine='371,true,false,true,false,true,true,false,false,true,20,5'
