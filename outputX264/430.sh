...
(gtime -f "USERTIME %U\nSYSTEMTIME %S\nELAPSEDTIME %e\nMEMORYTIME %K" x264 --no-asm --ref 1 --no-fast-pskip --no-deblock --no-8x8dct --no-mbtree --rc-lookahead 20   -o sintel$numb.flv $trailerlocation) 2> $logfilename
# size of the video
...
csvLine='430,true,true,true,false,true,true,true,false,false,20,1'
