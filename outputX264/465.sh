...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --no-fast-pskip --no-8x8dct --rc-lookahead 60 --no-mbtree --no-deblock   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='465,true,true,true,false,true,true,true,false,false,60,1'
