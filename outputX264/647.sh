...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --no-8x8dct --no-mbtree --rc-lookahead 40   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='647,true,true,true,false,false,false,true,false,false,40,1'
