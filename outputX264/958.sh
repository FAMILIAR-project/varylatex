...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --rc-lookahead 60 --no-deblock --no-mbtree --no-8x8dct   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='958,true,true,true,false,true,false,true,false,false,60,1'
