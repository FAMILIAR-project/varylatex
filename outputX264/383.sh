...
(gtime -f "USERTIME %U\nSYSTEMTIME %S\nELAPSEDTIME %e\nMEMORYTIME %K" x264 --no-asm --ref 9 --no-fast-pskip --no-mbtree --no-deblock --rc-lookahead 60 --no-8x8dct  --no-weightb --no-mixed-refs  -o sintel$numb.flv $trailerlocation) 2> $logfilename
# size of the video
...
csvLine='383,true,true,true,false,true,true,true,true,true,60,9'
