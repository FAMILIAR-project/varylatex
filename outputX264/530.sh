...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --no-mbtree --no-8x8dct --rc-lookahead 20  --no-cabac --no-mixed-refs  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='530,true,true,true,true,false,false,true,true,false,20,9'
