...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --no-fast-pskip --rc-lookahead 60 --no-deblock --no-8x8dct   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='1062,true,true,true,false,true,true,false,false,false,60,5'
