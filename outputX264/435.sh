...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --no-deblock --no-mbtree --rc-lookahead 20  --no-weightb  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='435,true,false,true,false,true,false,true,false,true,20,1'
