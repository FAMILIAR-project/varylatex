...
(gtime -f "USERTIME %U\nSYSTEMTIME %S\nELAPSEDTIME %e\nMEMORYTIME %K" x264 --no-asm --ref 5 --no-deblock --rc-lookahead 20  --no-mixed-refs  -o sintel$numb.flv $trailerlocation) 2> $logfilename
# size of the video
...
csvLine='942,true,false,true,false,true,false,false,true,false,20,5'
