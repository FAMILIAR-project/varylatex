...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 9 --no-fast-pskip --no-deblock --rc-lookahead 60 --no-mbtree --no-8x8dct  --no-cabac --no-weightb  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='533,true,true,true,true,true,true,true,false,true,60,9'
