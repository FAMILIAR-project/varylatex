...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --ref 5 --no-8x8dct --no-mbtree --rc-lookahead 20  --no-cabac  -o /srv/local/macher/bench3/tempvids/sintel$numb.264 $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='93,true,true,false,true,false,false,true,false,false,20,5'
