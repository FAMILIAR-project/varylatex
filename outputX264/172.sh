...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --no-fast-pskip --rc-lookahead 60 --no-8x8dct  --no-cabac  -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='172,true,true,true,true,false,true,false,false,false,60,1'
