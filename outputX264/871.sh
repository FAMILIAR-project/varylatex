...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 1 --no-fast-pskip --no-mbtree --no-deblock --rc-lookahead 20   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='871,true,false,true,false,true,true,true,false,false,20,1'
