...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --ref 5 --no-fast-pskip --no-deblock --rc-lookahead 40  --no-cabac --no-weightb  -o /srv/local/macher/bench3/tempvids/sintel$numb.264 $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='557,true,false,false,true,true,true,false,false,true,40,5'
