...
SYSTEMTIME %S                                                                                                      
ELAPSEDTIME %R"; { time ../x264/x264 --no-asm --ref 5 --no-fast-pskip --rc-lookahead 60 --no-8x8dct --no-deblock --no-mbtree   -o sintel$numb.flv $trailerlocation ; } 2> $logfilename
# size of the video
...
csvLine='489,true,true,true,false,true,true,true,false,false,60,5'
