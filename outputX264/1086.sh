...
(gtime -f "USERTIME %U\nSYSTEMTIME %S\nELAPSEDTIME %e\nMEMORYTIME %K" x264 --no-asm --ref 5 --no-fast-pskip --rc-lookahead 60 --no-deblock --no-mbtree   -o sintel$numb.flv $trailerlocation) 2> $logfilename
# size of the video
...
csvLine='1086,true,false,true,false,true,true,true,false,false,60,5'
