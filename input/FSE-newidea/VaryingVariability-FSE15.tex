...
\lstdefinelanguage{JavaScript}{
  ...
  basicstyle=\ttfamily{{#if JS_SCRIPTSIZE}}\scriptsize{{/if}}{{#if JS_TINY}}\tiny{{/if}}{{#if JS_FOOTNOTESIZE}}\footnotesize{{/if}}, % \footnotesize%\tiny, %or \scriptsize \small or \footnotesize etc.
...
\begin{figure}
\centering
\includegraphics[width={{{cserver_size}}}\linewidth]{figures/server-client.pdf}
\vspace*{-2mm}
...
{{#if PARAGRAPH_ACK}}\paragraph{Acknowledgements}{{/if}} We thank anonymous reviewers for their valuable feedbacks. % well-deserved! 
