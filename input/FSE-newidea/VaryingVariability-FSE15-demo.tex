...
\lstdefinelanguage{JavaScript}{
  ...
  basicstyle=\ttfamily\scriptsize, % \scriptsize \small or \footnotesize etc.
...
\begin{figure}
\centering
\includegraphics[width=1.0\linewidth]{figures/bref-generator.pdf}
\vspace*{-4mm}
...
\begin{figure}
\centering
\includegraphics[width=1.0\linewidth]{figures/server-client.pdf}
\vspace*{-2mm}
...
We thank anonymous reviewers for their valuable feedbacks.  We thank Pierre Laperdrix for the newspaper example. 
%
\scriptsize
\vspace*{-2mm}
